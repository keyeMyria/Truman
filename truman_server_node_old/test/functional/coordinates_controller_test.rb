...
class CoordinatesControllerTest < ActionController::TestCase
  ...
  test "should create coordinate" do
    assert_difference('Coordinate.count') do
      post :create, :coordinate => { :date => @coordinate.date, :latitude => @coordinate.latitude, :longitude => @coordinate.longitude }
    end
  ...
  test "should update coordinate" do
    put :update, :id => @coordinate, :coordinate => { :date => @coordinate.date, :latitude => @coordinate.latitude, :longitude => @coordinate.longitude }
    assert_redirected_to coordinate_path(assigns(:coordinate))
  end
